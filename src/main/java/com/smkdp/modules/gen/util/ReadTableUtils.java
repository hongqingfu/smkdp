package com.smkdp.modules.gen.util;
...
public class ReadTableUtils {
	...
	public List<String> readAllTableNames(GenDataSource dataSource) throws Exception {
	...
	public List<GenTableColumn> readTableColumn(GenDataSource dataSource, String tableName) throws Exception {
...
//			}
			...
			while(this.rs.next()){
				...
				column.setSort(Integer.valueOf(sort));
